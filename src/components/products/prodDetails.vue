<template>
    ...
    <div class="card bg-dark text-white drawer" :class="{show: active}">
        ...
        <div v-if="product" class="pDetails">
            ...
            <div class="buttonCon mt-5 text-center">
                <button class="remove border border-outline-light btn btn-danger btn-outline-light" @click="removetoCart()">Remove</button>
                <button class="add border border-outline-light btn btn-primary btn-outline-light mt-2" @click="addToCart()">Add</button>
            </div>
            </div>
        </div>
    </div>
